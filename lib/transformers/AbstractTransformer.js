...
class AbstractTransformer {
	...
	constructor( type, config ){
		...
		/**
		 * Allow transforms to define their own key names - default is column transformer name
		 */
		this.outputKeyName = _.has( config, 'outputKeyName' ) ? config.outputKeyName : null;
